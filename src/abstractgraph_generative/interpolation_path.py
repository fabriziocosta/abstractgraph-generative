...
`abstractgraph_generative.interpolation_generation` via `InterpolationGenerator`.
"""
...
from abstractgraph_generative.rewrite import iterated_rewrite, rewrite  # noqa: F401

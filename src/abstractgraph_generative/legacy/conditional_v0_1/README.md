...
```bash
python -m py_compile \
  src/abstractgraph_generative/legacy/conditional_v0_1/types.py \
  src/abstractgraph_generative/legacy/conditional_v0_1/utils.py \
  src/abstractgraph_generative/legacy/conditional_v0_1/materialization.py \
  src/abstractgraph_generative/legacy/conditional_v0_1/index_building.py \
  src/abstractgraph_generative/legacy/conditional_v0_1/generator_core.py \
  src/abstractgraph_generative/legacy/conditional_v0_1/dataset_generator.py \
  src/abstractgraph_generative/legacy/conditional_v0_1/__init__.py
```
